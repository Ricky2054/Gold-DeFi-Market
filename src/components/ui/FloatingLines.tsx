...
const vec3 GOLD  = vec3(212.0, 175.0, 55.0) / 255.0;
const vec3 DARK_GOLD = vec3(139.0, 109.0, 30.0) / 255.0;
...
vec3 background_color(vec2 uv) {
  ...
  col += mix(DARK_GOLD, BLACK, smoothstep(0.0, 1.0, abs(m)));
  ...
  useEffect(() => {
    ...
    const handlePointerMove = (event: PointerEvent) => {
      ...
      if (parallax) {
        ...
        targetParallaxRef.current.set(-px * parallaxStrength, py * parallaxStrength);
      }
    };
